  ...
  return (
    <Container>
      ...
      <NewUserForm>
        ...
        <NewUserItem>
          <NewUserItemLabel>Role</NewUserItemLabel>
          <NewUserItemInput type="text" placeholder="Admin"/>
        </NewUserItem>
        <NewUserItem>
          <NewUserItemLabel>Joining Date</NewUserItemLabel>
          <NewUserItemInput type="text" placeholder="01/02/2022"/>
        </NewUserItem>
        <NewUserItem>
